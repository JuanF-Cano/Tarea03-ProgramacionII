...
void PrintPattern(int column1, int column2, int column3, int index2) {
    if (column1 <= 9) {
        if (index2 <= 3) {
...
int main(){
    ...
    PrintPattern(1, 1, 1, 1); //Se llama a la funcion PrintPattern con los tres terminos iniciales y un index
